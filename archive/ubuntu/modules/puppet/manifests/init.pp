...
class puppet {
  ...
  file { "cron_puppet-agent":
    ...
    require    => File ["/etc/puppet/puppet.conf","/etc/default/puppet"],
  }
  ...
  file { "/etc/default/puppet":
    source => [
      "puppet:///modules/puppet/default_puppet_$::fqdn",
      "puppet:///modules/puppet/default_puppet_$::domain",
      "puppet:///modules/puppet/default_puppet",
    ],
    owner => 'root',
    group => 'root',
    mode  => '0644',
